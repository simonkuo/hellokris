...
echo "RX/BC Pll/OTC Use (Dates):&nbsp;&nbsp;" . "<b>" . $rxbcdate . "</b>";
...
echo "&nbsp;&nbsp;&nbsp:Alcohol while pumping:&nbsp;&nbsp;" . "<b>" . $alcohol . "</b>"; 
...
// Inserting donor into Donor Table
   ...
   $sql = "insert into screenertable (donornumber, firstname, lastname, middlename, dnrapdate, address, city, state, zip, country,  homephone, cellphone, email, referral, babysname, babysdob, babystatus, storefrom, milkcommit, herbs, alcohol, transfusion, createdby, donorpacket, donorcomment, donortype, organization, donateamount, rxbcdate) values ($dnum, '$fname', '$lname', '$mname', '$dnrapdate', '$address', '$city', '$state', '$zip', '$country', '$hphone', '$cphone', '$email', '$referral', '$babysname', '$babysdob', '$babystatus', '$storefrom', '$milkcommit', '$herbs', '$alcohol', '$transfusion', '$createdby', '$donorpacket', '$donorcomment', '$donortype', '$organization', $donateamount, '$rxbcdate')";
...
// Inserting donor into Donor Table Log
   ...
   $sql1 = "insert into screenertablelog (donornumber, firstname, lastname, middlename, dnrapdate, address, city, state, zip, country,  homephone, cellphone, email, referral, babysname, babysdob, babystatus, storefrom, milkcommit, herbs, alcohol, transfusion, createdby, transactionnumber, transactiontype, transactiondate, username, donorpacket, donorcomment, donortype, organization, donateamount, rxbcdate) values ($dnum, '$fname', '$lname', '$mname', '$dnrapdate', '$address', '$city', '$state', '$zip', '$country', '$hphone', '$cphone', '$email', '$referral', '$babysname', '$babysdob', '$babystatus', '$storefrom', '$milkcommit', '$herbs', '$alcohol', '$transfusion', '$createdby', 1, 'Created', '$dnrapdate', '$createdby', '$donorpacket', '$donorcomment', '$donortype', '$organization', $donateamount, '$rxbcdate')";
